...
class DynamicForm(QMainWindow):
    def __init__(self):
        ...
        self.setGeometry(100, 100, 500, 400)  # x, y, ширина, высота

        # ---------- 1. ГЛАВНЫЙ КОНТЕЙНЕР ----------
        # Создаем центральный виджет (обязательно для QMainWindow)
        ...
        self.layout.setContentsMargins(20, 20, 20, 20)  # отступы от краев

        # ---------- 4. ДАННЫЕ ДЛЯ ФОРМЫ (СПИСОК) ----------
        self.form_data = [
            {"type": "category", "text": "📋 Личная информация"},
            {"type": "input", "label": "Имя:", "placeholder": "Введите ваше имя"},
            {"type": "input", "label": "Email:", "placeholder": "example@mail.com"},
    ...
    def build_form(self, data):
        ...
        for item in data:
            ...
            # ---------- ПОЛЕ ВВОДА ТЕКСТА ----------
                ...
                lbl.setFixedWidth(100)  # фиксированная ширина для ровности
